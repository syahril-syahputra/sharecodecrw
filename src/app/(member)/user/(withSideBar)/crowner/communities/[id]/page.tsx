...
import { useDetailCommunity } from '@/feature/community/useDetailCommunity';
        ...
        <div className="container py-8">
            ...
            <section className="flex items-center justify-between">
                ...
                <div className="flex items-center space-x-2">
                    ...
                    />
                    <a href={`/user/crowner/communities/${params.id}/update`}>
                        <Button size={'sm'} variant={'secondary'}>
                            <Edit className="mr-2" />
                            Edit
                        </Button>
                    </a>
                    <DeleteCommunity id={params.id} />
                </div>
            </section>
            <section>
