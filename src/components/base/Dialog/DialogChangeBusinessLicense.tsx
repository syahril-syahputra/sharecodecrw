...
export default function DialogChangeBusinessLicense({
    isOpen,
    onOpenChange,
    refetch,
}: IProps) {
    ...
    const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file && file.type === 'application/pdf') {
            form.setValue('business_license', e.target.files);
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onOpenChange}>
            <DialogContent className="sm:max-w-[425px]">
                <DialogHeader>
                    <DialogTitle>Update Business License</DialogTitle>
                    <DialogDescription>
                        Upload your new business license
                    </DialogDescription>
                </DialogHeader>
                <Form {...form}>
                    <form>
                ...
                <DialogFooter>
                    ...
                    <Button
                        loading={isPending}
                        disabled={
                            isPending || !form.getValues('business_license')
                        }
